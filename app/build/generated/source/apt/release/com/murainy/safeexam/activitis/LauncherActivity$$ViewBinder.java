...
public class LauncherActivity$$ViewBinder<T extends LauncherActivity> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    View view;
    view = finder.findRequiredView(source, 2131624105, "field 'bnt_me' and method 'next'");
    target.bnt_me = finder.castView(view, 2131624105, "field 'bnt_me'");
    ...
    view = finder.findRequiredView(source, 2131624109, "field 'bnt_you' and method 'man'");
    target.bnt_you = finder.castView(view, 2131624109, "field 'bnt_you'");
