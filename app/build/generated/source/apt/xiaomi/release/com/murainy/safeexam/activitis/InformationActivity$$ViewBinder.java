...
public class InformationActivity$$ViewBinder<T extends InformationActivity> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131624106, "field 'bnt_exit' and method 'exit'");
    target.bnt_exit = finder.castView(view, 2131624106, "field 'bnt_exit'");
    ...
    view = finder.findRequiredView(source, 2131624107, "field 'bnt_end' and method 'exitsys'");
    target.bnt_end = finder.castView(view, 2131624107, "field 'bnt_end'");
