...
public class UserBindPhoneActivity$$ViewBinder<T extends UserBindPhoneActivity> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    View view;
    view = finder.findRequiredView(source, 2131624242, "field 'iv_left' and method 'back'");
    target.iv_left = finder.castView(view, 2131624242, "field 'iv_left'");
    unbinder.view2131624242 = view;
    ...
    view = finder.findRequiredView(source, 2131624072, "field 'et_number'");
    ...
    view = finder.findRequiredView(source, 2131624244, "field 'tv_title'");
    target.tv_title = finder.castView(view, 2131624244, "field 'tv_title'");
    ...
    view = finder.findRequiredView(source, 2131624075, "field 'tv_bind' and method 'bind'");
    target.tv_bind = finder.castView(view, 2131624075, "field 'tv_bind'");
    unbinder.view2131624075 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
        target.bind();
