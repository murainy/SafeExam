...
public class UserBindPhoneActivity$$ViewBinder<T extends UserBindPhoneActivity> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131624070, "field 'et_number'");
    target.et_number = finder.castView(view, 2131624070, "field 'et_number'");
    view = finder.findRequiredView(source, 2131624071, "field 'et_input'");
    target.et_input = finder.castView(view, 2131624071, "field 'et_input'");
    ...
    view = finder.findRequiredView(source, 2131624072, "field 'tv_send' and method 'send'");
    target.tv_send = finder.castView(view, 2131624072, "field 'tv_send'");
    ...
    view = finder.findRequiredView(source, 2131624073, "field 'tv_bind' and method 'bind'");
    target.tv_bind = finder.castView(view, 2131624073, "field 'tv_bind'");
    unbinder.view2131624073 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
        target.bind();
