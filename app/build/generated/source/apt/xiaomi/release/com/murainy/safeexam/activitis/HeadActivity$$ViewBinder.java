...
public class HeadActivity$$ViewBinder<T extends HeadActivity> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131689632, "field 'upload' and method 'upload'");
    target.upload = finder.castView(view, 2131689632, "field 'upload'");
    unbinder.view2131689632 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
        target.upload(p0);
