...
import com.murainy.safeexam.entity.MultipleItem;
import com.murainy.safeexam.entity.MySection;
import com.murainy.safeexam.entity.Status;
import com.murainy.safeexam.entity.Video;
...
public class DataServer {
    ...
    public static List<Status> getSampleData(int lenth) {
        ...
        for (int i = 0; i < lenth; i++) {
            ...
            status.setText("BaseRecyclerViewAdpaterHelper https://murainy.github.io");
            list.add(status);
        }
        return list;
    }
    ...
    public static List<Status> addData(List list, int dataSize) {
        for (int i = 0; i < dataSize; i++) {
            ...
            status.setRetweet(i % 2 == 0);
            status.setUserAvatar("https://github.com/murainy/murainy.github.io/blob/master/12.png?raw=true");
            status.setText("Powerful and flexible RecyclerAdapter https://murainy.github.io");
            list.add(status);
        }
