...
private void setupStatusBarView(Context context, ViewGroup decorViewGroup) {
    ...
    Toolbar.LayoutParams params = new Toolbar.LayoutParams(Toolbar.LayoutParams.MATCH_PARENT, mConfig.getStatusBarHeight());
...
private void setupNavBarView(Context context, ViewGroup decorViewGroup) {
    ...
    if (mConfig.isNavigationAtBottom()) {
        params = new Toolbar.LayoutParams(Toolbar.LayoutParams.MATCH_PARENT, mConfig.getNavigationBarHeight());
        params.gravity = Gravity.BOTTOM;
    } else {
        params = new Toolbar.LayoutParams(mConfig.getNavigationBarWidth(), Toolbar.LayoutParams.MATCH_PARENT);
