...
public class AddPaperActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
	    ...
	    addPaperDialog = findViewById(R.id.add_paper_dialog);
	    inputPaperId = findViewById(R.id.et_paper_id);
	    inputPaperName = findViewById(R.id.et_paper_name);
	    addQuestionBtn = findViewById(R.id.add_question);
	    finishBtn = findViewById(R.id.finish);
	    Button dialogSureBtn = findViewById(R.id.dialog_sure);
	    ImageButton backBtn = findViewById(R.id.btn_back);
	    TextView paperDate = findViewById(R.id.tv_paper_date);
	    id = findViewById(R.id.tv_id);
	    questionET = findViewById(R.id.et_question);
	    optionAET = findViewById(R.id.et_optionA);
	    optionBET = findViewById(R.id.et_optionB);
	    optionCET = findViewById(R.id.et_optionC);
	    optionDET = findViewById(R.id.et_optionD);
	    optionA = findViewById(R.id.cb_option_A);
	    optionB = findViewById(R.id.cb_option_B);
	    optionC = findViewById(R.id.cb_option_C);
	    optionD = findViewById(R.id.cb_option_D);
